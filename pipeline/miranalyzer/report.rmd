...
do_permutation = function(realvalue, max.heatmap, res.dt, rld, con, treat){
...
do_permutation(deg_res[["acc"]], deg_res[["max"]], deg_res[["res"]],deg_res[["log"]],"cc","ct")


deg_res = do_de_heatmap(multi,15,28,"pc","pt","unique_pt")
do_permutation(deg_res[["acc"]], deg_res[["max"]], deg_res[["res"]],deg_res[["log"]],"pc","pt")
